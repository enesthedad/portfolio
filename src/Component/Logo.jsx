...
import okIcon from "../Imgs/okavatar.webp";
...
const Logo = (props) => {
  ...
  return type === "footer" ? (
    <div className="flex items-center gap-4 md:gap-4 lg:gap-4">
      ...
      <h1 className="logo w-1/3 text-[16px] md:text-[20px] mt-[-20px] lg:text-[20px] text-white items-center  font-bold justify-center flex">
        <a href="/">
