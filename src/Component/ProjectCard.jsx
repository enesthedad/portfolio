...
const ProjectCard = () => {
  return (
    <div className="bg-stone-50 rounded-lg w-4/5 mx-auto py-10 px-5    flex gap-20">
      <div className="wide-card w-2/3 bg-white rounded-lg px-8 py-4">
        <div className="header flex justify-between items-center p-4">
          <div className="left py-8 flex flex-col gap-3 px-4">
        ...
        <div className="project-img flex bg-slate-500 rounded-md p-10 justify-center">
          <img
      ...
      <div className="little-card   w-1/3 bg-white rounded-md flex flex-col justify-start items-center p-10">
        <div className="header flex gap-10 bg-stone-100 m-8 p-4 border-2 rounded-xl">
          <img
        ...
        <div className="body w-full h-full justify-between flex flex-col p-10 rounded-md bg-slate-500">
          <div className="project-img flex w-full   gap-5 p-2 flex-col items-center">
            <h2>Project was about</h2>
            <div className="tags flex gap-2 ">
              <p className="bg-emerald-500 px-2 py-1 rounded-md">tag</p>
              <p className="bg-sky-500 px-2 py-1 rounded-md">tag</p>
            </div>
          </div>
          <div className="source p-4 flex items-center justify-between">
            <h2>source code</h2>
            <a
              href="#"
              className="bg-zinc-600  px-3 py-1 rounded-md text-stone-200"
            >
              github
            </a>
          </div>
