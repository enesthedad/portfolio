  ...
  return (
    ...
    >
      <div className="inline-block w-full h-full grid-cols-5 grid-rows-5 gap-4 md:grid">
        <div className="rounded-2xl flex mb-4 md:m-0 col-start-2 col-span-2 row-start-5 md:flex gap-4 shadow-md justify-center items-center bg-[#F7F7F7] p-4 font-bold text-[24px] lg:text-[40px] md:text-[36px]">
          <img
            src={laptopAvatar}
            alt=""
        ...
        <div className="col-span-2 mb-4 shadow-md  md:m-0 about-me flex justify-center items-center row-span-2 bg-[#F7F7F7] p-4 lg:p-10 md:p-4 rounded-2xl">
          <p>
            <p className="text-[16px] md:text-[13px] tracking-wider  font-light">
        ...
        <div className="md:flex md:w-full h-auto md:h-full inline  shadow-md items-center md:justify-start md:items-end justify-center col-start-3 row-span-2 bg-[#f7f7f7] overflow-hidden rounded-2xl">
          <img
            src={helloAvatar}
            alt=""
            className="h-[100px] absolute md:relative md:h-full object-cover right-10 md:scale-150 md:ml-[-15px] "
          />
        </div>
        ...
        <div className="col-start-1 mb-4 lg:m-0 shadow-md row-start-3 font-semibold text-[48px] md:justify-center md:items-start gap-2 flex md:flex-col justify-between items-center rounded-2xl text-stone-800 bg-[#f7f7f7] p-4">
          <div className=" flex text-[20px] md:text-[16px]  gap-2">
            <p>Resume</p>
          </div>
          <a
            href=""
            className="text-[18px] md:text-[12px]  shadow-md flex gap-2 px-3 py-2 md:p-1 md:gap-1 bg-[#FDFDE3] rounded-lg text-stone-700"
          >
            <p>
        ...
        <div className="col-start-1 mb-4 lg:m-0 shadow-md row-start-4 font-semibold text-[48px] md:justify-center md:items-start gap-2 flex md:flex-col justify-between items-center rounded-2xl text-stone-800 bg-[#f7f7f7] p-4">
          <div className=" flex text-[20px] md:text-[16px] gap-2">
            <p>Projects</p>
          </div>
          <a
            href=""
            className="text-[18px] shadow-md md:text-[12px]  flex gap-2 px-2 py-1 bg-[#CFF8E6] rounded-lg text-stone-700"
          >
            <p>
        ...
        <div className="col-start-1 mb-4 lg:m-0 shadow-md row-start-5 font-semibold text-[48px] md:justify-center md:items-start gap-2 flex md:flex-col justify-between items-center rounded-2xl text-stone-800 bg-[#f7f7f7] p-4">
          <div className=" flex text-[20px] md:text-[16px] gap-2">
            <p>Blog</p>
          </div>
          <a
            href=""
            className="text-[18px] flex gap-2 shadow-md  md:text-[12px]  px-2 py-1 bg-[#CCD0FF] rounded-lg text-stone-700"
          >
            <p>
